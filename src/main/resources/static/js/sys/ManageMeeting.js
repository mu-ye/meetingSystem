$(function () {
    ...
    function addFunction(value,row,index){
        ...
        '  <button id="btn-edit" type="button" class="btn btn-info">会议编辑</button>\n' +
        '  <button id="btn-files" type="button" class="btn btn-default">文件编辑</button>\n' +
        '</div>'].join()
    }
    ...
    window.event = {
        'click #btn-edit' : function (e,value,row,index){
            let id=row.id;
            //console.log("ManageMeeting-meetingId"+id)
            localStorage.setItem("ManageMeeting-meetingId",id)
            window.location.href="index/editMeeting";
        },
        'click #btn-files' : function (e,value,row,index){
            let id=row.id;
            //console.log("EditFiles-meetingId"+id)
            localStorage.setItem("EditFiles-meetingId",id)
            window.location.href="index/editFiles";
        }
    }
