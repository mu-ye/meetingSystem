...
public class WaterMarkUtil {
     ...
     * @throws IOException
     */
    public static String getUrlPost(String localPath,String downloadUrl,String waterMark,String fileName) throws IOException {
        String result ="内部错误";
     ...
     * @throws IOException
     */
    public static String getFileInfo(String localPath, String downloadUrl,String waterMark,String fileName) throws IOException {
